...
Original file is located at
    https://colab.research.google.com/drive/1QR6AmzdJ7nWF-aBRCXeMwdkJbpo8bFAS
"""
...
sprint_atual = sprint_date(datetime.now().strftime('%Y-%m-%d'))
...
table_summary[['yield_cumsum', 'task_concluded_cumsum']].plot(kind='line',
                                                              ...
                                                              title='Burnup Chart',
                                                              xlabel='Sprint',
                                                              ylabel='Count').get_figure().savefig('Burnup_Chart.jpg')
